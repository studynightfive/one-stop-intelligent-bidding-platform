  ...
  return (
    <div data-testid={EVAL_TEST_IDS.dashboard} className="p-6">
      ...
      <div className="bg-white border border-[#E2E8F0] rounded-xl p-3 mb-4 flex flex-col md:flex-row md:items-center gap-2">
        ...
        />
        <Button icon={<RotateCcw size={14} />} onClick={() => { setKeyword(''); setAssignee('all'); setFilter('all') }} data-testid={EVAL_TEST_IDS.dashboardReset}>重置筛选</Button>
      ...
      <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-3 mb-4">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <Button icon={<Link2 size={14} />} className="!rounded-lg" onClick={() => navigate('/evaluation/portal/EVAL-2026-001')} data-testid={EVAL_TEST_IDS.dashboardPortal}>
            打开供应商门户（外部）
          </Button>
          <Button type="primary" icon={<Plus size={14} />} className="!rounded-lg !bg-[#2563EB]" onClick={() => navigate('/evaluation/create')} data-testid={EVAL_TEST_IDS.dashboardCreate}>
            创建评标任务
          </Button>
          <Segmented
            value={viewMode}
