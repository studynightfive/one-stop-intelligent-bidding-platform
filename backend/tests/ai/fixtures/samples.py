...
SAMPLES: tuple[Sample, ...] = (
    ...
    Sample(
        ...
        expected_provider="fake",
        required_keys=("planApproved", "sectionPlan", "warnings"),
    ),
    Sample(
        prompt_name="bid_generate_paragraph",
        prompt_version="1.0.0",
        payload={
            "templateName": "技术方案模板",
            "sectionHeading": "技术总体方案",
            "headingLevel": 1,
            "sectionInstructions": "说明总体架构",
            "paragraphIndex": 1,
            "paragraphCount": 2,
            "targetWords": 200,
        ...
        expected_provider="fake",
        required_keys=("paragraph", "evidence"),
    ),
    Sample(
