...
class EvalRiskTask(M7Task):
    """串标识别 / 异常报价识别。"""

    name = "app.workers.eval_risk.check"
    scene = "risk_check"
        ...
        if output.provider_status == ProviderStatus.OFFLINE:
            return self.make_partial_result(
                ...
                output={
                    ...
                    "highRiskCount": structured.get("highRiskCount", 0),
                },
