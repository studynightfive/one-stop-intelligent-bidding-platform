...
class BiddingAuditorTask(M7Task):
    """形式审查 / 实质性审查（V3.1 § 8.3 AI 检查）。"""

    name = "app.workers.bidding_auditor.review"
    scene = "bid_review"
