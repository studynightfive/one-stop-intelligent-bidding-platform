...
async def update_user(
    ...
    try:
        user = await user_service.update_user(
            ...
            role=UserRole(request.dict(exclude_unset=True).get("role", "")) if request.dict(exclude_unset=True).get("role") else None,
        )
    ...
    roles = [
        {
            ...
            "permissions": [
                ...
                "bids:read", "bids:write", "bids:review",
