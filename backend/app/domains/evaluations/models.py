...
class SupplierSubmissionModel(Base):
    ...
    __table_args__ = (
        UniqueConstraint("supplier_id", "material_id", name="uq_supplier_material_submission"),
    )
...
class ScoreItemModel(Base):
    ...
    __table_args__ = (
        UniqueConstraint("evaluation_id", "supplier_id", "criterion_id", name="uq_score_item"),
    )
...
class EvaluationIdempotencyModel(Base):
    ...
    __table_args__ = (
        UniqueConstraint("tenant_id", "idempotency_key", name="uq_evaluation_idempotency"),
    )
